...
contract TokensRecipient is ERC820Implementer, ERC820ImplementerInterface, ERC777TokensRecipient {

    bool private preventTokenReceived;

    function TokensRecipient(bool _setInterface, bool _preventTokenReceived) public {
